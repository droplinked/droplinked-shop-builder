...
const ProducerInfoCard = ({ price, commission, shopDetails, availableItems, shopId }: Props) => {
  ...
  return (
    <Box p="6" w="100%" bg="#1b1b1b" borderRadius="lg" display="flex" flexDirection={{ base: 'column', xl: 'row' }} alignItems={{ base: 'flex-start', xl: 'center' }} gap={{ base: '4', xl: '0' }}>
...
const ProducerInfoSection = ({ shopDetails, shopId }: { shopDetails; shopId }) => (
