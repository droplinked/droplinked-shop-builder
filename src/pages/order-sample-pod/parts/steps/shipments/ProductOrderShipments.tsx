            ...
            <ProductOrderCard title={t("shipments.title")}>
                <Flex direction={"column"} gap={4}>
                    <RadioGroup className={classes.fullwidth} onChange={e => updateState('rateId', e)}>
                        <Flex direction={"column"} gap={4}>
                            ...
                            <Flex justifyContent="space-between" alignItems="center">
                                <AppTypography fontSize="16px" color="#C2C2C2">{t("shipments.tax")}</AppTypography>
                    ...
                    <Flex flexDirection="row-reverse" gap={4}>
                        <BasicButton onClick={submit} isLoading={isLoading}>{t("shipments.payWithStripe")}</BasicButton>
                        <BasicButton onClick={() => {
