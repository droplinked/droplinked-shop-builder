...
/**
 * Available sections in the storefront preview
 */
...
export interface ShopDesignPage {
  ...
  shopDesign?: {
    ...
    bannerLinks?: Array<AdditionalLinks>;
    footerLinks?: Array<AdditionalLinks>;
 ...
 * Designer page state
 */
export interface StateDesignPage {
...
/**
 * Actions for the designer reducer
 */
export type DesignerActions =
  | {
      type: 'updateState';
      params: StateDesignPage;
    }
  | {
      type: 'updateShop';
      params: ShopDesignPage;
    };
