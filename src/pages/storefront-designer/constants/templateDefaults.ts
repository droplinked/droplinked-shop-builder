import { ITemplateOptions } from '../types/designerTypes';

/**
 * Default template options for the storefront designer
 * Contains all the styling options for different components of the storefront
 */
