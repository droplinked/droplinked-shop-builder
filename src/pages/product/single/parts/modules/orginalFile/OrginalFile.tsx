...
function OrginalFile() {
    const { state: { digitalDetail: { file_url } }, loading, methods: { dispatch } } = useContext(productContext)
        ...
        <VStack align="stretch">
            ...
            <AppSkeleton isLoaded={loading}>
                <HStack backgroundColor="#141414" spacing="1px" padding="2px" borderRadius="8px">
                    ...
                    <Box width="100%"><AppInput name='link' width="100%" value={file_url} onChange={el => dispatch({ type: "updateDigitalLinks", params: { file_url: el.target.value } })} color="#808080" placeholder='www.example.com/original-artwork-123' /></Box>
                </HStack>
            </AppSkeleton>
