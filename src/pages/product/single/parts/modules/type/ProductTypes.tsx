        ...
        <VStack align={"stretch"} spacing={7}>
            <Box>
                <AppSkeleton isLoaded={loading} width={"70%"}>
                    <Checkbox size='md' isChecked={product_type === "PRINT_ON_DEMAND"} alignItems="flex-start" colorScheme='green' onChange={() => changeProductType("PRINT_ON_DEMAND")}>
            ...
            <Box>
                <AppSkeleton isLoaded={loading}>
                    <Checkbox size='md' isChecked={product_type === "DIGITAL"} alignItems="flex-start" colorScheme='green' onChange={() => changeProductType("DIGITAL")}>
                        <VStack align='stretch' paddingLeft={2} spacing={1}>
