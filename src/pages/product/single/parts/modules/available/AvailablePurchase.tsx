    ...
    return (
        <Flex gap={3}>
            ...
            <VStack align='stretch' color="#C2C2C2" spacing={1}>
                <AppTypography fontSize='14px' fontWeight='bold'>Available to purchase</AppTypography>
                <AppTypography fontSize='14px'>If you deactivate this field the customer will not be able to add the item to the cart.</AppTypography>
            </VStack>
        </Flex>
    )
}
