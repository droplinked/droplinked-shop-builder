  ...
  return (
    <div className="merch-page-wrapper d-flex justify-content-between">
      ...
      <div className="detail-side col-12 col-md-6">
        ...
        <p className="merch-brandname" onClick={navigateToShoppage}>
          {shopname}
        </p>
        ...
        <div style={{ height: "auto" }}>
          {sku && sku.quantity == 0 ? (
            ...
            <BasicButton click={Addtobasket} loading={disableBtn}>
              Add to basket
            </BasicButton>
          )}
        </div>
      ...
      <div className="merch-description-wrapper">
        <p
          className={`merch-description ${
            readmore ? "" : "merch-limite-description"
          }`}
        >
          {product.description}
        </p>
