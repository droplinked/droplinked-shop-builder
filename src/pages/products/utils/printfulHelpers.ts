// Utility to get unique items by value
export const getUniqueItems = (data: { value: string }[]) => {
    const uniqueData: { value: string }[] = []
...
// Printful-specific styles
export const printfulStyles = {
    variables: {
