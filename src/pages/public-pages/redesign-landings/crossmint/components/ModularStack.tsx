...
export default function ModularStack() {
    const cardsData: CardData[] = [{
        ...
        children: <img width="100%" height="100%" alt='products-icons' src='https://upload-file-droplinked.s3.amazonaws.com/a011794e8a2da29dfb241e853e2382bebfbed7e0505f0a21a86ead66f01e1bff.png' />
    }, {
        ...
        gridColumn: { base: "1fr", md: "span 1", lg: "span 1" },
        children: <img width="100%" height="100%" alt='products-icons' src='https://upload-file-droplinked.s3.amazonaws.com/692b7055b74f370007199b6f1cac42e7a8522e7780841f7d0855a043cd21a8bc.png' />
    }, {
