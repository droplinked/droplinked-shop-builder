      ...
      <g clip-path="url(#clip0_11577_165)">
        <g filter="url(#filter0_i_11577_165)">
          <path
            ...
            fill="url(#paint0_radial_11577_165)"
          />
          <path
            d="M95.5 48C95.5 21.7665 74.2335 0.5 48 0.5C21.7665 0.5 0.5 21.7665 0.5 48C0.5 74.2335 21.7665 95.5 48 95.5C74.2335 95.5 95.5 74.2335 95.5 48Z"
            stroke="url(#paint1_radial_11577_165)"
          />
        </g>
        <path
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            mode="normal"
            in2="shape"
            result="effect1_innerShadow_11577_165"
          />
        </filter>
        <radialGradient
          id="paint0_radial_11577_165"
          cx="0"
          cy="0"
          r="1"
        ...
        <radialGradient
          id="paint1_radial_11577_165"
          cx="0"
          cy="0"
          r="1"
          gradientUnits="userSpaceOnUse"
          gradientTransform="translate(1.89731e-06 48) scale(48)"
        >
