        ...
        >
            <Box paddingInline={paddingInline} margin="48px auto auto">
                <Box
                    ...
                    borderBottom="none"
                    background="radial-gradient(50% 100% at 50% 0%, rgba(43, 207, 161, 0.24) 0%, rgba(43, 207, 161, 0.00) 100%), linear-gradient(180deg, rgba(43, 207, 161, 0.08) 0%, rgba(43, 207, 161, 0.00) 100%)"
                    backdropFilter="blur(50px)"
                >
                    <Box background="neutral.websiteBackground" borderRadius="16px 16px 0 0">
                        <QuestWindow />
                    </Box>
                </Box>
            </Box>
