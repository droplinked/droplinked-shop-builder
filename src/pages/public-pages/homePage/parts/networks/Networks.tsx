    ...
    return (
        <Flex justifyContent="center" alignItems="center" padding="50px 0">
            <VStack width="95%" justifyContent="center" color="#FFF">
                ...
                <Box padding="10px 0 30px 0"><LandingDescription text="Transparent publisher partnerships and smart contracts to evolve affiliate marketing with efficiency and autonomy" /></Box>
