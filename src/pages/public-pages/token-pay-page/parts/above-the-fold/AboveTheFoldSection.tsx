  ...
  return (
    <Flex direction={{ base: "column", xl: "row" }} alignItems={"center"} gap={{ base: 14, xl: 20 }}>
      <Flex direction={"column"} gap={{ base: 14, xl: 20 }} order={{ base: 2, xl: 1 }}>
        <CustomHeading title="Token Powered Commerce Driven by Your Community" textAlign={{ base: "center", xl: "start" }} />
        <AppTypography fontSize={{ base: 20, lg: 24 }} color={"#fff"} textAlign={{ base: "center", xl: "start" }}>
          Leverage Tokenpay with any erc20, brc20 and SPL tokens to unlock real utility for communities.
        </AppTypography>
        <BasicButton alignSelf={{ base: "center", xl: "start" }}>Get Started</BasicButton>
      </Flex>
      <Image
