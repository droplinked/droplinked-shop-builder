...
function FeatureCard({ feature }: { feature: Feature }) {
    ...
    const imageUrl = typeof image === 'string' ? image : (isSmallerThan768 ? image.base : image.md)

    return (
        <Flex direction="column" border="1px solid #222" borderRadius={16} overflow="hidden" gap={{ base: 4, md: 8 }}>
            <Flex direction="column" gap={{ base: 4, md: 8 }} p={{ base: 4, md: 8 }}>
                {icon}
                <Box>
