...
const D3Wallet: React.FC<ID3WalletProps> = ({ width = "625px", height = "400px", variant = "green", isLoading = false, icon = "wallet" }) => {
    const isGreen = variant === "green";
    const color = isGreen ? "#2BCFA1" : "#FF2244";

    const circleBoxes = [
        { top: "-149.5px", left: "-37.5px", width: "699px", height: "699px", opacity: isGreen ? 0.01 : 0.09 },
        { top: "-114.5px", left: "-2.5px", width: "629px", height: "629px", opacity: isGreen ? 0.01 : 0.1 },
        { top: "-82.5px", left: "30.5px", width: "564px", height: "564px", opacity: isGreen ? 0.02 : 0.11 },
        { top: "-52.5px", left: "60.5px", width: "504px", height: "504px", opacity: isGreen ? 0.03 : 0.12 },
        { top: "-24.5px", left: "87.5px", width: "449px", height: "449px", opacity: isGreen ? 0.04 : 0.13 },
        { top: "0.5px", left: "112.5px", width: "399px", height: "399px", opacity: isLoading ? 0.08 : 0.16, borderWidth: "2px" },
    ];
    ...
    const renderSVGContent = () => (
        <>
            ...
            <g filter="url(#filter1_bii_20474_640_false)">
            ...
            <g filter="url(#filter1_bii_20474_640_true)">
    ...
    return (
        <Box width={width} height={height} position="relative" overflow="hidden">
            ...
            {circleBoxes.map((box, index) => (
                <CircleBox key={index} borderColor={isGreen ? "white" : color} {...box} />
            ))}
