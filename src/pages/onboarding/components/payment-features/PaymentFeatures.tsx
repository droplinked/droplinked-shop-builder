  ...
  const cards = [
    {
      ...
      titleKey: 'Merchant Wallet',
      descriptionKey: 'The merchant wallet enables USDC acceptance for all businesses. It offers a secure and seamless way to manage revenue while minimizing merchant processing fees.'
    },
    {
      ...
      titleKey: 'Customizable Currency Preferences',
      descriptionKey: 'Choose your preferred fiat or crypto currencies.'
    },
    {
      ...
      titleKey: 'Tokenpay',
      descriptionKey: 'Enable acceptance of thousands of various digital assets.'
    }
  ]
