  ...
  return (
    <AppCard>
      <VStack
        ...
        <VStack align={"stretch"}>
          <Box>
            <FieldLabel
              label="IMS Type"
              textProps={{ size: "18px", weight: "bolder" }}
              isRequired
            />
          </Box>
          <Box>
              ...
              {imsType ? (
                <>
                  <AppTypography
                    ...
                    fontWeight="bold"
                    display={"inline"}>
                    {capitalizeFirstLetter(imsType)}
                  </AppTypography>
                  : You can add and manage your products right from you
                  droplinked dashboard
                </>
              ) : (
                  ...
                  <Radio
                    ...
                    <VStack
                      ...
                      <Text
                        fontSize="sm"
                        color="lightGray">
                        You can add and manage your products through shopify,
                        and then import the changes to your droplinked store
                      </Text>
                    </VStack>
                  </Radio>
                </BlackBox>
      ...
      <AppDialog
        ...
        text={
          <>
            Once you have selected the IMS type, it cannot be changed. Make sure
