        ...
        <>
            <Flex backgroundColor="#141414" cursor="pointer" onClick={onOpen} position="relative" padding="24px 20px" gap="20px" borderRadius="8px" {...props}>
                <VStack align="stretch">
                    <AppTypography fontSize="14px">Embed Code</AppTypography>
                    <AppTypography fontSize="14px" color="#808080">Embed HTML or CSS code to implement a custom design</AppTypography>
                </VStack>
                <Box>
