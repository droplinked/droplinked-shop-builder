        ...
        full: [
            {
                key: "right_text",
                icon: <svg width="32" height="16" viewBox="0 0 32 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect width="32" height="16" rx="3" fill="#C2C2C2" />
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M12 5.5C12 4.67157 12.6716 4 13.5 4H26.5C27.3284 4 28 4.67157 28 5.5C28 6.32843 27.3284 7 26.5 7H13.5C12.6716 7 12 6.32843 12 5.5Z" fill="#808080" />
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M12 10.5C12 9.67157 12.6716 9 13.5 9H19C19.8284 9 20.5 9.67157 20.5 10.5C20.5 11.3284 19.8284 12 19 12H13.5C12.6716 12 12 11.3284 12 10.5Z" fill="#808080" />
                </svg>
            },
            {
                key: "left_text",
                icon: <svg width="32" height="16" viewBox="0 0 32 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect width="32" height="16" rx="3" fill="#C2C2C2" />
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M4 5.5C4 4.67157 4.67157 4 5.5 4H18.5C19.3284 4 20 4.67157 20 5.5C20 6.32843 19.3284 7 18.5 7H5.5C4.67157 7 4 6.32843 4 5.5Z" fill="#808080" />
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M4 10.5C4 9.67157 4.67157 9 5.5 9H11C11.8284 9 12.5 9.67157 12.5 10.5C12.5 11.3284 11.8284 12 11 12H5.5C4.67157 12 4 11.3284 4 10.5Z" fill="#808080" />
                </svg>
            },
            {
                key: "center_text",
                icon: <svg width="32" height="16" viewBox="0 0 32 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect width="32" height="16" rx="3" fill="#C2C2C2" />
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M25 8C25 8.82843 24.3284 9.5 23.5 9.5H8.5C7.67157 9.5 7 8.82843 7 8C7 7.17157 7.67157 6.5 8.5 6.5H23.5C24.3284 6.5 25 7.17157 25 8Z" fill="#808080" />
                </svg>
            },
        ]
    }
