...
function PreviewHomepage() {
    ...
    const scrollTargetSections = isCollectionShown ? ["profile"] : [ "products", "profile"]
    
    return (
        <Flex ref={scrollTargetSections.includes(optionSelected) ? scrollRef : null} justifyContent="center" padding={isDesktop ? "80px 0" : "10px 0"} {...template_options?.['--dlk-wrp']?.['--dlk-wrp-styles']}>
