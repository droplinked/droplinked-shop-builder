        ...
        <Flex direction="column" gap="36px">
            ...
            <WithPermission requiredPermission="create_referral_code" >
                <Flex direction="column" gap="12px">
                    <AppTypography fontSize="16px" fontWeight={500} color="neutral.gray.300">Referral Link</AppTypography>
                    <Flex justifyContent="space-between" alignItems="center"><AppTypography fontSize="16px" fontWeight={400} color="neutral.gray.300">{`${BUILDER_URL}/?modal=signup&referral=${code.toLowerCase()}`}</AppTypography><ClipboardText text={`${BUILDER_URL}/?modal=signup&referral=${code.toLowerCase()}`} /></Flex>
                    <Flex gap="8px" alignItems="center"><AppIcons.InfoIcon /><AppTypography color="neutral.gray.300" fontSize="12px" fontWeight="400">Users also have the option to enter the code <span style={{ fontWeight: 700 }}>{code}</span> in their signup form.</AppTypography></Flex>
                </Flex>
                <Flex direction="column" gap="12px"><AppTypography fontSize="16px" fontWeight={500} color="neutral.gray.300">Custom Referral Code</AppTypography>
                    <Flex direction="column" gap="8px"><AppTypography fontSize="14px" fontWeight={500} color="#808080">Create and share your personalized referral code and share it with anyone.</AppTypography>
                        <form ref={ref} onSubmit={handleSubmit}>
                            <Flex alignItems="center" backgroundColor="neutral-background" paddingRight="7.5px" rounded="8px" style={{ border: `1px solid ${errors.customCode ? '#E63F43' : 'transparent'}` }}>
