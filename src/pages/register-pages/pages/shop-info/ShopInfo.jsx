...
const RegisterShopInfo = () => {
  ...
  return (
    <>
      <PageContent>
        <AppCard>
          <AppTypography size="18px" weight="bolder">Store info</AppTypography>
          <AppTypography color="#C2C2C2" size="14px" marginTop={2}>
          ...
          <FormControl isRequired mt={16} mb={10}>
            <FieldLabel isRequired label="Shop Address" />
            <AppTypography size="14px" color="#C2C2C2" marginTop={2}>The location of you / your physical store / where you store your products.</AppTypography>
          </FormControl>
