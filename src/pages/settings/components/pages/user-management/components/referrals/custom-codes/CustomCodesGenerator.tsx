...
export default function CustomCodesGenerator() {
    ...
    const handleCopyLink = () => {
        const link = `${BUILDER_URL}/?modal=signup&referral=${value.toLowerCase()}`;
            ...
            <Input
                ...
                rightElement={
                    <>
                        ...
                        >
                            {customCode ? "Edit" : "Create"}
                        </Button>
                        {customCode && <AppIcons.Copy onClick={handleCopyLink} style={{ width: "24px", height: "24px", cursor: "pointer" }} />}
                    </>
                }
            />
        </Flex>
