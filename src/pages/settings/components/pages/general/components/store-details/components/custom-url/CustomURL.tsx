        ...
        <SectionContent
            ...
            rightContent={
                <Input
                    ...
                    rightElement={
                        <Button borderRadius={4} isDisabled={!url} isLoading={isFetching} onClick={shopDomain ? onDnsModalOpen : onOpen} fontSize={"12px"} height={"32px"} paddingInline={{ base: 3, lg: 3 }} padding={1}>
