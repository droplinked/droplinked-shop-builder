...
export default function PaymentToken({ icon, title, onClick }: Props) {
    return (
        <Flex width={"100%"} border={"1px solid neutral.gray.800"} bg={"#141414"} borderRadius={"8px"} p={4} justifyContent={"space-between"} alignItems={"center"}>
            <Flex width={"100%"} alignItems={"center"} gap={4}>
                <Box sx={{ svg: { width: "24px", height: "24px" } }} p={3} bg={"neutral.gray.1000"} border={"1px solid neutral.gray.800"} borderRadius={"8px"}>
                    {icon}
                </Box>
