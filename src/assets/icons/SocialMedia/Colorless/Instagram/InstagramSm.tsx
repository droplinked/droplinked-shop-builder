...
export const InstagramSm = (props) => (
...
<path d="M11 2H5C3.34315 2 2 3.34315 2 5V11C2 12.6569 3.34315 14 5 14H11C12.6569 14 14 12.6569 14 11V5C14 3.34315 12.6569 2 11 2Z" stroke="black" strokeLinecap="round" strokeLinejoin="round"/>
