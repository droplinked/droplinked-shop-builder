...
export const SidebarcollapseLg = (props: SVGProps<SVGSVGElement>) => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M16.25 10L14.5 12L16.25 14" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        <rect x="5" y="5" width="6" height="14" rx="1" fill="currentColor" />
    </svg>
