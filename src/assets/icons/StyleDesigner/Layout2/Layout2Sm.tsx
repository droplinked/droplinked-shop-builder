...
export const Layout2Sm = ({ color = "currentColor", ...props }: SVGProps<SVGSVGElement>) => (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <path d="M6.5 6.5V13" stroke={color} strokeLinecap="round" strokeLinejoin="round" />
        <path d="M2 6.5H14" stroke={color} strokeLinecap="round" strokeLinejoin="round" />
