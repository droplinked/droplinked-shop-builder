...
export const CartLg = ({ color = "currentColor", ...props }: SVGProps<SVGSVGElement>) => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        ...
        <path d="M3 5H4.55679C4.84054 5 5.09412 5.17457 5.1918 5.43717L8.09848 13.2513C8.48919 14.3017 9.50349 15 10.6385 15H16.6062C17.7706 15 18.8045 14.2655 19.1728 13.1767L20.9647 7.87748C21.1108 7.4458 20.7848 7 20.3231 7H10.1016" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
