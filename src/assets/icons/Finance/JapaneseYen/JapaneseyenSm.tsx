...
export const JapaneseyenSm = ({ color = "currentColor", ...props }: SVGProps<SVGSVGElement>) => (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        ...
        <path d="M8 8.5V13.5" stroke={color} strokeLinecap="round" strokeLinejoin="round" />
        <path d="M12.5 3L8 8.5L3.5 3" stroke={color} strokeLinecap="round" strokeLinejoin="round" />
    </svg>
