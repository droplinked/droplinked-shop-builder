...
export const WalletMd = ({ color = "black", ...props }: SVGProps<SVGSVGElement>) => (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        ...
        <path d="M18.7992 11.6417V13.3584C18.7992 13.8168 18.4325 14.1917 17.9658 14.2084H16.3325C15.4325 14.2084 14.6075 13.5501 14.5325 12.6501C14.4825 12.1251 14.6825 11.6334 15.0325 11.2917C15.3408 10.9751 15.7658 10.7917 16.2325 10.7917H17.9658C18.4325 10.8084 18.7992 11.1834 18.7992 11.6417Z" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M5.8335 10H11.6668" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
