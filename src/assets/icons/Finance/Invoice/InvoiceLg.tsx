...
export const InvoiceLg = (props: SVGProps<SVGSVGElement>) => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M13.5 8C13.5 8.55228 13.9477 9 14.5 9H15.5C16.0523 9 16.5 8.55228 16.5 8C16.5 7.44772 16.0523 7 15.5 7H14.5C13.9477 7 13.5 6.55228 13.5 6C13.5 5.44772 13.9477 5 14.5 5H15.5C16.0523 5 16.5 5.44772 16.5 6M15 4.5V9.5" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
