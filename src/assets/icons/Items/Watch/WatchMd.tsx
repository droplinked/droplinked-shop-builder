...
export const WatchMd = ({ color = "currentColor", ...props }: SVGProps<SVGSVGElement>) => (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        ...
        <path d="M6.875 14.6772L7.40703 17.6116C7.43319 17.7556 7.50907 17.8859 7.62143 17.9797C7.73379 18.0735 7.87551 18.1249 8.02188 18.1249H11.9781C12.1245 18.1249 12.2662 18.0735 12.3786 17.9797C12.4909 17.8859 12.5668 17.7556 12.593 17.6116L13.125 14.6772" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M10 6.875V10H13.125" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
