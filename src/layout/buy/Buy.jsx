							...
							<div className="col-8 " style={{ height: '100vh' }}>
								<div className="main-shop">
									...
									<div className="product-price">
										{products.variants[0].formatted_price}
									</div>
									{/* options */}
									<div className="options-main">
										{/* row1 */}
										<div className="option-row option-row-1"></div>
										{/* row1 */}
										...
										<div className="option-row option-row-2">
											{products.options[1] ? (
												<>
													<select
														...
														style={{ left: '138px', order: '1' }}
													>
														<option value="volvo">
															{products.options[1].values[0]}
														</option>
														<option value="saab">
															{products.options[1].values[1]}
														</option>
														<option value="fiat">
															{products.options[1].values[2]}
														</option>
														<option value="audi">
															{products.options[1].values[3]}
														</option>
													</select>
												</>
											) : (
											...
											>
												<option value="volvo">
													{products.options[0].values[0]}
												</option>
												<option value="saab">
													{products.options[0].values[1]}
												</option>
												<option value="fiat">
													{products.options[0].values[2]}
												</option>
												<option value="audi">
													{products.options[0].values[3]}
												</option>
											</select>
										</div>
										{/* row2 */}

										<div className="option-row option-row-3"></div>
									</div>
									{/* options */}
									...
									{!cartItems.find(
										...
										>
											<i class="bi bi-cart"></i>Add to basket
										</button>
									)}
									{/* button group */}
							...
							<div className="col-3" style={{ height: '100vh' }}>
								<div className="my-cart-container container d-flex ">
									...
									>
										...
										<div className="cart-total-cost col-7">
