...
const NOtificationItem = ({ updateNotifications, notif, close }) => {
  ...
  return (
    <Flex p="15px 0px" borderBottom="1px" borderColor="#666">
      <Box w="35px" minW="35px" borderRight="2px" borderColor="#666" pr="10px">
        <MdOutlineMessage
          style={{ width: "100%", height: "100%", fill: "white" }}
        />
      </Box>

      <Box pl="10px" cursor="pointer" onClick={clickNotification}>
        <Text
