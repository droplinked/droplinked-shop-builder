import { ArrowleftLg } from 'assets/icons/Navigation/ArrowLeft/ArrowleftLg';
...
export const getLevelUpSections = (t: TFunction, isRTL: boolean) => [
  {
    ...
    subSections: [
      {
        title: t('LevelUpWidget.sections.createFirstProduct.physical.title'),
        description: t('LevelUpWidget.sections.createFirstProduct.physical.description'),
        link: { linkTitle: t('LevelUpWidget.common.learnMore'), linkTo: '/analytics' },
        image: 'https://upload-file-droplinked.s3.amazonaws.com/215575e99677753f8ba8277f621ac9a36eda99e621cdd60b1b69d3d8ce11da4d.png',
        buttons: {
          right: {
            label: t('LevelUpWidget.common.next'),
            rightIcon: isRTL ? ArrowleftLg : ArrowrightLg,
            onClick: (setCurrentSubSection) => setCurrentSubSection((prev) => prev + 1)
          }
        }
      },
      {
        title: t('LevelUpWidget.sections.createFirstProduct.digital.title'),
        description: t('LevelUpWidget.sections.createFirstProduct.digital.description'),
        link: { linkTitle: t('LevelUpWidget.common.learnMore'), linkTo: '/analytics' },
        image: 'https://upload-file-droplinked.s3.amazonaws.com/59fe00a4b64ec51e04c4c0b80927ddd9e021d6aa2b418e26ba7ee19c0aad6796.png',
        buttons: {
          left: {
            label: t('LevelUpWidget.common.back'),
            onClick: (setCurrentSubSection) => setCurrentSubSection((prev) => prev - 1)
          },
          right: {
            label: t('LevelUpWidget.common.next'),
      ...
      {
        title: t('LevelUpWidget.sections.createFirstProduct.onDemand.title'),
        description: t('LevelUpWidget.sections.createFirstProduct.onDemand.description'),
        link: {
          linkTitle: t('LevelUpWidget.common.learnMoreHelpCenter'),
        ...
        buttons: {
          ...
          right: {
            label: t('LevelUpWidget.common.createProduct'),
  ...
  {
    title: t('LevelUpWidget.sections.customizeShop.title'),
    objectField: 'customizeShop',
    subSections: [
      {
        title: t('LevelUpWidget.sections.customizeShop.storefront.title'),
        description: t('LevelUpWidget.sections.customizeShop.storefront.description'),
        image: 'https://upload-file-droplinked.s3.amazonaws.com/4c9b32fd20d246052ea848063380e6edbfba9bcda424d6de84a8b16427918ecc.png',
        buttons: {
          right: {
            label: t('LevelUpWidget.common.storefrontCustomization'),
            rightIcon: isRTL ? ExternalarrowleftLg : ExternalarrowLg,
            onClick: (setCurrentSubSection, onClose, navigate) => {
              onClose?.()
  ...
  {
    title: t('LevelUpWidget.sections.joinAffiliateMarket.title'),
    objectField: 'joinAffiliateMarket',
    subSections: [
      {
        title: t('LevelUpWidget.sections.joinAffiliateMarket.main.title'),
        description: t('LevelUpWidget.sections.joinAffiliateMarket.main.description'),
        image: 'https://upload-file-droplinked.s3.amazonaws.com/da9dbffc0e3a12de5ba1505f433b25204f8de0ed0b16684922caa3b5423ef7b1.png',
        buttons: {
          right: {
            label: t('LevelUpWidget.common.affiliateMarket'),
            rightIcon: isRTL ? ExternalarrowleftLg : ExternalarrowLg,
            onClick: (setCurrentSubSection, onClose, navigate) => {
              onClose?.()
  ...
  {
    title: t('LevelUpWidget.sections.sellFirstProduct.title'),
    objectField: 'sellFirstProduct',
    subSections: [
      {
        title: t('LevelUpWidget.sections.sellFirstProduct.firstOrder.title'),
        description: t('LevelUpWidget.sections.sellFirstProduct.firstOrder.description'),
        link: {
          linkTitle: t('LevelUpWidget.common.learnMoreHelpCenter'),
          linkTo: 'https://droplinked.gitbook.io/droplinked-store-front-help-center/about-us/what-is-droplinked',
          isExternal: true
      ...
      {
        title: t('LevelUpWidget.sections.sellFirstProduct.productLink.title'),
        description: t('LevelUpWidget.sections.sellFirstProduct.productLink.description'),
        link: {
          linkTitle: t('LevelUpWidget.common.learnMoreHelpCenter'),
          linkTo: 'https://droplinked.gitbook.io/droplinked-store-front-help-center/about-us/what-is-droplinked',
          isExternal: true
      ...
      {
        title: t('LevelUpWidget.sections.sellFirstProduct.productTile.title'),
        description: t('LevelUpWidget.sections.sellFirstProduct.productTile.description'),
        link: {
          linkTitle: t('LevelUpWidget.common.learnMoreHelpCenter'),
          linkTo: 'https://droplinked.gitbook.io/droplinked-store-front-help-center/about-us/what-is-droplinked',
          isExternal: true
      ...
      {
        title: t('LevelUpWidget.sections.sellFirstProduct.socialTile.title'),
        description: t('LevelUpWidget.sections.sellFirstProduct.socialTile.description'),
        link: {
          linkTitle: t('LevelUpWidget.common.learnMoreHelpCenter'),
          linkTo: 'https://droplinked.gitbook.io/droplinked-store-front-help-center/about-us/what-is-droplinked',
          isExternal: true
