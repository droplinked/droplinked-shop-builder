...
export const BASE_URL = appDevelopment ? origin === "https://stage.droplinked.com" ? process.env.REACT_APP_BASE_API_URL_STAGE : process.env.REACT_APP_BASE_API_URL_DEV : process.env.REACT_APP_BASE_API_URL
