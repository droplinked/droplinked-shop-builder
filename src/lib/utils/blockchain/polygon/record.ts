 ...
 */
export async function record_merch(sku_properties: any, address: string, product_title: string, discription: string, image_url: string, price: number, amount: number, comission: number, apiKey = process.env.REACT_APP_RECORD_MATCH_POLYGON) {
