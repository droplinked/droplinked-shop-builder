 ...
 */
export async function record_merch_polygon(sku_properties: any, address: string, product_title: string, discription: string, image_url: string, price: number, amount: number, comission: number) {
