...
export const sidebar_constants: SidebarGroup[] = [
    {
        ...
        items: [
            ...
            },
            {
                ...
                linkTo: null,
                list: [ { listTitle: "Market", linkTo: "/dashboard/affiliate/market" }, { listTitle: "Stores", linkTo: "/dashboard/affiliate/stores" }, { listTitle: "Products", linkTo: "/dashboard/affiliate" } ],
            },
        ],
    },
    {
