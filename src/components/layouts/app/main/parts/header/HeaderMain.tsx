    ...
    const products_menu = [
        {
            label: "Products",
            links: [
                { label: "Physical Products", description: "All our items in one place", icon: <AppIcons.Bag />, href: "/physical-product" },
                { label: "Digital Products", description: "Shop by type and interest", icon: <AppIcons.Gallery />, href: "/digital-product" },
                { label: "Print on Demand", description: "Themed and seasonal product selections", icon: <AppIcons.Shirt />, href: "/pod-product" },
            ],
        },
        {
            label: "Services",
            links: [{ label: "Token Integration", description: "All our items in one place", icon: <AppIcons.Coins />, href: "tokenpay" }],
        },
    ]
